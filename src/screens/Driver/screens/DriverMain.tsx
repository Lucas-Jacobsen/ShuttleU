    ...
    <NavigationContainer independent={true}>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen
          ...
          options={{ title: "ViewReservations" }}
        />
        <Stack.Screen
          name="ViewShuttleLogs"
          component={ViewShuttleLogs}
          options={{ title: "ViewShuttleLogs" }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
    ...
    <View style={styles.container}>
      ...
      >
        <View>
          ...
          <Pressable
            style={styles.button}
            onPress={() => props.navigation.push("StartTrip")}
          >
            <Text style={styles.text}>Start Trip</Text>
          </Pressable>
          <Pressable
            style={styles.button}
            onPress={() => props.navigation.push("ViewReservations")}
          >
            <Text style={styles.text}>Reservations</Text>
          </Pressable>
          <Pressable
            style={styles.button}
            onPress={() => props.navigation.push("ViewShuttleLogs")}
          >
